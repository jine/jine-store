  ...
  return (
    <div className="container mx-auto px-4grid p-3 bg-white">
      ...
      <div className="grid grid-cols-2 mb-4">
        ...
        <h2 className="p-3 font-semibold text-foreground text-m">{product.title}</h2>
        ...
        <h3 className="p-3 text-sm">Kategori: {product.category}</h3>
        <p className="p-3 font-bold text-foreground text-m">{Math.floor(product.price)*10} SEK</p>
